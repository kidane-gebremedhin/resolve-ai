...
const tabs = [
  {
    ...
    description: 'We built Kida to give every support team—from scrappy startups to global enterprises—access to AI-powered tools that actually work. Our mission is to make exceptional customer support the default, not the exception.',
  ...
  },
  {
    ...
    description: 'Founded in 2019, Kida started as an internal tool used by a small team obsessed with cutting response times. Today it\'s a full-featured AI platform serving hundreds of companies globally, with 24/7 uptime and enterprise-grade security.',
