import { blogs } from '@/data/ns-blogs';
      ...
      <section className="lg:py-[100px] py-20 sm:py-24 bg-background-2 dark:bg-background-5">
        <div className="main-container">
          <div className="text-center space-y-5 md:mb-[70px] mb-10">
            <RevealAnimation delay={0.1}>
              <span className="badge badge-green">Resources &amp; Insights</span>
            </RevealAnimation>
            <div className="space-y-3">
              <RevealAnimation delay={0.2}>
                <h2>Learn how top teams handle support</h2>
              </RevealAnimation>
              <RevealAnimation delay={0.3}>
                <p className="max-w-[492px] mx-auto">
                  Guides, experiments, and real-world insights around AI, customer experience, and support operations.
                </p>
              </RevealAnimation>
            </div>
          </div>
          ...
          <RevealAnimation delay={0.6}>
            <div className="flex justify-center mt-14">
              <LinkButton href="/blog" className="btn btn-secondary dark:btn-transparent btn-md hover:btn-green w-[90%] md:w-auto mx-auto md:mx-0">
