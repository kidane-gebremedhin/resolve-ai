          ...
          <div className="max-w-[400px] mx-auto bg-background-1 dark:bg-background-6 rounded-[20px] py-14 px-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <label className="inline-flex items-center gap-2 cursor-pointer">
                    ...
                    <span className="text-tagline-2 text-secondary font-medium select-none dark:text-accent">Remember me</span>
                  </label>
                </div>
                <div>
                  <a href="#" className="text-tagline-2 text-secondary font-medium underline dark:text-accent">Forgot password?</a>
                </div>
              </div>
              <div className="mt-8">
            ...
            <div>
              <p className="text-center text-tagline-2 text-secondary font-normal flex items-center justify-center gap-1 dark:text-accent">
                Not registered yet?
                <a href="/signup" className="text-tagline-1 font-medium footer-link-v2">Create an Account</a>
              </p>
