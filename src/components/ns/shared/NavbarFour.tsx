        ...
        <div className="mx-auto flex w-full max-w-[1920px] items-center justify-between">
          <div>
            <a href="/">
              ...
              <img src="/images/shared/logo-green.svg" alt="NextSaaS" className="h-8" />
            </a>
          </div>
          <div className="flex items-center gap-[76px]">
            ...
            <div className="flex items-center gap-2">
              <a href="/signup" className="btn btn-primary hover:btn-white-dark btn-md hidden sm:inline-block">
