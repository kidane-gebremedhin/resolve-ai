...
const stories = [
  { co: "Northwind", industry: "B2B SaaS", quote: "We deflected 71% of tier-1 tickets in the first month. CSAT went up.", who: "Maya Okafor, VP Support", metric: "−43%", metricLabel: "median handle time" },
  { co: "Lumen Health", industry: "Healthcare", quote: "Helio handles intake at 3am so our nurses don't have to. Game-changing.", who: "Dr. Idris Khan, COO", metric: "24/7", metricLabel: "automated triage" },
  { co: "Routebound", industry: "Logistics", quote: "Replaced Zendesk + Intercom + a homegrown bot in one weekend.", who: "Anya Petrov, Head of CX", metric: "3 → 1", metricLabel: "tools consolidated" },
  { co: "Petalwise", industry: "DTC", quote: "Our agents stopped copy-pasting and started actually talking to customers.", who: "Sam Reyes, Support Lead", metric: "+18", metricLabel: "NPS in Q1" },
];
