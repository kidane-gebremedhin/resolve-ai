          ...
          <div className="prose prose-invert max-w-none space-y-8 text-primary-50">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Email: <a href="mailto:support@addisai.com" className="text-primary underline underline-offset-2">support@addisai.com</a></li>
            ...
            <div>
              ...
              <p>Email: <a href="mailto:support@addisai.com" className="text-primary underline underline-offset-2">support@addisai.com</a></p>
