...
export const metadata: Metadata = {
  ...
  description: 'Privacy policy for ShipFaster.',
};
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-primary-50">
            ...
            <div>
              ...
              <p>Welcome to ShipFaster, operated by ML Labs (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;). We are committed to protecting your personal information and your right to privacy. This policy explains how we collect, use, disclose, and safeguard your information when you use our platform.</p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>URLs and websites analyzed using their tools</li>
                <li>SEO audit results and reports generated by the software</li>
                <li>Keywords and search queries tracked</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Provide, maintain, and improve automated SEO analysis services</li>
            ...
            <div>
              ...
              <p>ML Labs implements appropriate technical and organizational security measures to protect your personal information. However, no method of transmission over the Internet is 100% secure, and we cannot guarantee absolute security.</p>
            </div>
            ...
            <div>
              ...
              <p>Questions should be directed to: <a href="mailto:privacy@shipfaster.app" className="text-primary underline underline-offset-2">privacy@shipfaster.app</a></p>
            </div>
