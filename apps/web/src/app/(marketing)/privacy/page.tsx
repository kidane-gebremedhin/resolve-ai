        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-primary-50">
            ...
            <div>
              ...
              <p>Welcome to {APP_NAME}, operated by {APP_LEGAL_NAME} (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;). We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform.</p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>Billing information and payment details for subscription services (processed by Paddle)</li>
                <li>Profile information you choose to provide</li>
                <li>Communication preferences</li>
              </ul>
              <p className="font-medium text-primary mt-4 mb-2">Usage Information</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Websites and data you manage using our tools</li>
                <li>Reports and results generated by our software</li>
            ...
            <div>
              ...
              <p>All payment transactions are processed by Paddle.com, who acts as the Merchant of Record. Paddle maintains appropriate administrative, physical, and technical safeguards for protection of the security, confidentiality and integrity of your payment data. For more information, please refer to Paddle&apos;s Privacy Policy at paddle.com/legal/privacy.</p>
            </div>

            <div>
              <h2 className="text-xl font-semibold text-primary mb-3">5. Data Sharing and Disclosure</h2>
              <p className="mb-2">We do not sell your personal information. We may share your information in the following situations:</p>
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li><span className="font-medium text-primary">With Your Consent:</span> When you have given us permission to share</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p>Email: <a href={`mailto:privacy@${APP_NAME.toLowerCase()}.app`} className="text-primary underline underline-offset-2">privacy@{APP_NAME.toLowerCase()}.app</a></p>
            </div>
