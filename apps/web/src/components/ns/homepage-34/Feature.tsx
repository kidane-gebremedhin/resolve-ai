  ...
  return (
    <RevealAnimation delay={0.1}>
      <section
        ...
        style={{ backgroundImage: "url('/images/gradient/gradient-39.png')", backgroundRepeat: 'no-repeat', backgroundPosition: 'bottom', backgroundSize: 'cover' }}
      >
        <div className="main-container">
          <div className="space-y-3 text-center md:mb-[70px] mb-13">
            <RevealAnimation delay={0.1}>
              <h2 className="text-accent">All-in-one customer support platform</h2>
            </RevealAnimation>
