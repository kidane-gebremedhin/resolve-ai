  ...
  return (
    ...
    >
      <div className="absolute top-[10%] left-1/2 -translate-x-1/2 max-w-[1365px] mx-auto -z-10">
        <figure>
          <Image
            src="/images/home-page-34/hero-vector.svg"
            alt=""
            width={1365}
            height={800}
            aria-hidden
      ...
      <div className="main-container">
        <div className="md:text-center md:space-y-4 space-y-5">
          ...
          <RevealAnimation delay={0.2}>
            <p className="lg:max-w-[700px] md:max-w-[600px] sm:max-w-[500px] max-w-[380px] mx-auto text-accent/60">
              Whether you&apos;re a startup or an enterprise, {APP_NAME} gives you everything you need to resolve tickets faster—from AI automation to real-time insights—all in one platform.
            </p>
          </RevealAnimation>
        ...
        <RevealAnimation delay={0.8} instant>
          <div className="lg:mt-[100px] mt-[50px]">
            <figure
              className="xl:max-w-[1240px] lg:max-w-[900px] max-w-[700px] mx-auto rounded-2xl overflow-hidden"
              suppressHydrationWarning
            >
              <Image
                src="/images/home-page-34/hero.jpg"
                className="w-full h-full object-cover dark:hidden"
                alt="AI customer support platform"
                width={2488}
                height={1436}
                priority
                sizes="(max-width: 768px) 90vw, (max-width: 1280px) 900px, 1240px"
              />
              <Image
                src="/images/home-page-34/hero-dark.jpg"
