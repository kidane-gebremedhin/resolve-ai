...
import ragMetrics from "./rag-metrics.routes.js";
import indexHealth from "./index-health.routes.js";
...
router.use("/rag-metrics", ragMetrics);
router.use("/index-health", indexHealth);
